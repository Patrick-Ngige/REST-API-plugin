...
if (isset($_POST['createbtn'])) {
    ...
    $response = wp_remote_post(
        'http://localhost/rest-api/wp-json/ra/v1/products',
        array(
            'method' => 'POST',
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-outline mb-3">
                                            <label class="form-label" for="form2Example17 "
                                                style="font-weight:600;">Product ID:</label>
                                        ...
                                        <div class="form-outline mb-3">
                                            <label class="form-label" for="form2Example27"
                                                style="font-weight:600;">Product name:</label>
                                            <input type="text" id="form2Example27" class="form-control form-control-md"
                                                placeholder="Enter product details" name="product" required />
                                        </div>

                                        <div class="form-outline mb-3">
                                            <label class="form-label" for="form2Example27"
                                                style="font-weight:600;">Product Details:</label>
                                            <input type="text" id="form2Example27" class="form-control form-control-md"
                                                placeholder="Enter product details" name="type" required />
                                        </div>
